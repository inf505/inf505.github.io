...
Choose the single most appropriate path based on what the user just shared and what would be therapeutically useful right now. State the chosen path clearly at the start of your response (e.g., "Path: Explore").
